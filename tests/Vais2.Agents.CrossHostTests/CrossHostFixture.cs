...
using Vais2.Agents.Persistence.Postgres;
using Vais2.Agents.Persistence.Redis;
using Xunit;
...
public sealed class CrossHostFixture : IAsyncLifetime
{
    ...
    private static async Task ApplyOrleansPostgresSchemaAsync(string connectionString)
    {
        ...
        {
            "Vais2.Agents.CrossHostTests.Sql.PostgreSQL-Main.sql",
            "Vais2.Agents.CrossHostTests.Sql.PostgreSQL-Persistence.sql",
        })
        {
