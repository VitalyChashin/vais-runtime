...
internal sealed class McpEventStoreInitializer : IHostedService
{
    private readonly IMcpEventStore _store;
    private readonly McpEventStoreOptions _options;

    public McpEventStoreInitializer(IMcpEventStore store, IOptions<McpEventStoreOptions> options)
    {
        _store = store;
