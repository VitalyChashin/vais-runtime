...
/// <summary>
/// Orleans grain that owns the persisted manifests for a single MCP gateway config id.
/// Primary key = <c>configId</c>; state is a version → manifest map.
/// </summary>
public interface IMcpGatewayConfigRegistryGrain : IGrainWithStringKey
{
...
/// Used by <c>OrleansMcpGatewayConfigRegistry.ListAsync</c>.
/// </summary>
public interface IMcpGatewayConfigRegistryDirectoryGrain : IGrainWithStringKey
{
