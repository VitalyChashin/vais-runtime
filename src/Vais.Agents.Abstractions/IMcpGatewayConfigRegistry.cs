...
/// <summary>
/// Registry of <see cref="McpGatewayConfigManifest"/> records.
...
/// </remarks>
public interface IMcpGatewayConfigRegistry
{
    ...
    ValueTask<McpGatewayConfigManifest?> GetAsync(
    ...
    ValueTask RegisterAsync(McpGatewayConfigManifest manifest, CancellationToken ct = default);
