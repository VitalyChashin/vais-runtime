...
export const getAgent = (c: VaisClient, id: string) => c.get<AgentManifest>(`/v1/agents/${id}`)
...
export const getGraph = (c: VaisClient, id: string) => c.get<AgentGraphManifest>(`/v1/graphs/${id}`)
...
export const getLlmGateway = (c: VaisClient, id: string) => c.get<LlmGatewayConfigManifest>(`/v1/llm-gateways/${id}`)
...
export const getMcpGateway = (c: VaisClient, id: string) => c.get<McpGatewayConfigManifest>(`/v1/mcp-gateways/${id}`)
...
export const getMcpServer = (c: VaisClient, id: string) => c.get<McpServerManifest>(`/v1/mcp-servers/${id}`)
