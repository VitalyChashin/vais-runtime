...
public sealed class ControlAbstractionsTests
{
    ...
    {
        // 7 agent + 7 graph (v0.19) + 12 gateway (v0.20) + 4 container-plugin (v0.24) + 3 eval-suite (E1) + 4 extension (EXT-13) + 4 plugin/DLL (PG-1) + 1 recipe (Plan D-12).
        Enum.GetValues<PolicyOperation>().Length.Should().Be(42);
    }
}
