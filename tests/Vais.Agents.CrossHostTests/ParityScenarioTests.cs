...
/// <see cref="Vais.Agents.Hosting.InMemory.InMemoryAgentRuntime"/> and two Orleans hosts (Redis-backed +
...
/// <remarks>
/// <para>
/// Why this matters: the three hosts wire <see cref="Vais.Agents.Core.StatefulAiAgent"/> through
/// completely different plumbing. InMemory is a plain object graph. Orleans wraps
/// the same agent in <see cref="Vais.Agents.Hosting.Orleans.AiAgentGrain"/> and shuttles state through
