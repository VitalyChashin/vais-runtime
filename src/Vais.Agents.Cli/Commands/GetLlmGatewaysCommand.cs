        ...
        try
        {
            if (string.IsNullOrWhiteSpace(settings.Name))
            {
                ...
                if (format == OutputFormat.Table)
                    ...
                    OutputFormatter.WriteManifestEnvelopeList(response.Items, "LlmGatewayConfig", format, AnsiConsole.Console);
            ...
            if (singleFormat == OutputFormat.Table)
                ...
                OutputFormatter.WriteManifestEnvelope(single.Manifest, "LlmGatewayConfig", singleFormat, AnsiConsole.Console);
            return ProblemDetailsParser.ExitSuccess;
        }
