...
public sealed record GraphAgentRef(string Id, string? Version = null, string? RuntimeUrl = null, [property: System.Text.Json.Serialization.JsonPropertyName("a2aUrl")] string? A2AUrl = null);
