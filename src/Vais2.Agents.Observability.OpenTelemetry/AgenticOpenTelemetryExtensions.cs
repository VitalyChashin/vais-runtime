...
namespace Vais2.Agents.Observability.OpenTelemetry;

/// <summary>
/// OpenTelemetry wiring helpers for <c>Vais2.Agents</c>. Lets consumers register
...
{
    /// <summary>
    /// Add the <c>Vais2.Agents</c> ActivitySource to a <see cref="TracerProviderBuilder"/>.
    /// </summary>
    ...
    /// <summary>
    /// Add the <c>Vais2.Agents</c> Meter to a <see cref="MeterProviderBuilder"/>.
    /// </summary>
    /// <returns>The same builder for chaining.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="builder"/> is null.</exception>
    ...
    /// Consumers still need to attach the <c>Vais2.Agents</c> meter to their OTel
