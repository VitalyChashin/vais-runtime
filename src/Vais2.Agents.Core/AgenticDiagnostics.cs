...
/// <summary>
/// Well-known diagnostic identifiers for Vais2.Agents. Consumers wire these up to their
...
/// <c>Vais2.Agents.Observability.OpenTelemetry</c> package.
/// </summary>
/// <remarks>
...
public static class AgenticDiagnostics
{
    ...
    /// Consumers register it on a <c>TracerProviderBuilder</c> via <c>.AddSource("Vais2.Agents")</c>.
    /// </summary>
    public const string ActivitySourceName = "Vais2.Agents";

    /// <summary>
    /// Meter name consumed by <c>OpenTelemetryUsageSink</c>.
    /// Consumers register it on a <c>MeterProviderBuilder</c> via <c>.AddMeter("Vais2.Agents")</c>.
    /// </summary>
    public const string MeterName = "Vais2.Agents";
...
/// <summary>
/// Centralised OTel GenAI tag names (see ADR 0002) plus Vais2-specific extensions.
